        ...
        <>
            <div>
                ...
                <div className="content mt-3">
                    ...
                    <p className={'text-sm mt-1 text-slate-600'}>{content || "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid asperiores eligendi excepturi fuga harum incidunt itaque iusto laborum laudantium maxime modi mollitia, natus nesciunt nobis placeat quaerat quod, tenetur velit."}</p>
                </div> {/* Content */}
            </div> {/* First Div */}
        </>
    );
