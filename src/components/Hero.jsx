...
const Hero = () => {
    return (
        <div className={'w-full justify-center px-16 flex-col flex text-center py-16 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500'}>
            <div className={'w-full grid md:grid-cols-2 justify-items-center items-center py-10 sm:hidden'}>
                <div>
                ...
                <div>
                    <div className={'bg-red-400 md:w-[27rem] h-[27rem] shadow-lg border border-amber-50 border-4 border-slate-300 md:rounded-full custom__img'}>
