...
const CreateBlog = () => {
    ...
    const handleAddBlog =  async () => {
        setIsLoading(true)
        const result = await handleCreateBlog(article)
                ...
                <div className={'w-full flex items-center'}>
                    ...
                    <div className={'w-full h-screen md:p-20 p-6'}>
                        ...
                        <div className="mt-8">
                            ...
                            <div className={'py-6'}>
                                <button disabled={isLoading} onClick={handleAddBlog} className="inline-flex p-3 rounded-sm bg-pink-500 text-white text-sm">
